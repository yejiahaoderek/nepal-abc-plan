...
> - 页面「已确认：西雅图→上海已定；9-25 上海会合确定」「9/25 四位团员在上海会合」：**证伪**。事实源：叶 9/24 晚 YVR 值机、3U 经成都 9/26 10:45 抵 KTM；帅组 9/26 PVG→KMG→KTM 15:35 抵；**四人 9/26 加德满都会合**，不存在上海会合与西雅图段（H2）。
...
这个顺序是产品直觉：先给全貌和空间锚点（Overview + 地图），再给待办，再给细节，最后落地到时间。
...
- 少一点，不要铁律：给方向和例子，不给 `--bg:#000000` 这类底线式规定
